package GameStages {
	...
	public class GameStage_TrainingRoomG extends GameStage {

		public function GameStage_TrainingRoomG( s:Stage, scenario:Object, interactionDisp:EventDispatcher, walls:Boolean ) {
			// constructor code
			this.gameStage = s;

package GameStages {
	...
	public class GameStage_TrainingRoomB extends GameStage {

		public function GameStage_TrainingRoomB( s:Stage, scenario:Object, interactionDisp:EventDispatcher, walls:Boolean ) {
			// constructor code
			this.gameStage = s;
